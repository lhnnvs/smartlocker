...
<body class="d-flex min-vh-100" style="background-color: #333;">
  <div class="d-flex flex-column align-items-center text-center text-white fs-3 p-5 w-100" style="background-image: url('../public/assets/images/bg.jpg');">
  ...
  <div class="d-flex justify-content-center bg-white fs-5 p-5 w-100">
    <form action="" method="POST" class="w-75">
      ...
      <div class="d-flex flex-column mb-4">
        ...
        <input type="text" class="border-1 rounded-1 p-2" name="email" placeholder="Enter your email address" value="<?= get_var('email') ?>">
      </div>
      <div class="d-flex flex-column mb-4">
        <label for="" class="fw-bold mb-2">Password</label>
        <input type="password" class="border-1 rounded-1 p-2" name="password" placeholder="Enter your password">
      </div>
      ...
      <div class="d-flex justify-content-center gap-5 mt-5 px-5">
        <button type="submit" class="btn btn-secondary border-0 rounded-pill w-100" style="background-color: #3a4058">Sign In</button>
        <button type="submit" class="btn btn-light border-1 rounded-pill w-100" style="border-color: gray">Sign Up</button>
      </div>
    </form>
  </div>
