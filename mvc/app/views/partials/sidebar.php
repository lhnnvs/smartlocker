...
<body class="d-flex vh-100" style="background-color: #f1f4fb">
    <div class="d-flex flex-column text-white p-3" style="max-width: 250px; position: relative; background-image: url('<?= ROOT ?>/assets/images/bg.jpg'); background-size: cover;">
        ...
        <a href="<?= ROOT ?>/home" class="d-flex align-items-center text-white text-decoration-none hover-bg-light rounded px-5 py-3 mb-2 w-100">
            <i class="bi bi-house-door me-2"></i>Dashboard
        </a>
        <a href="<?= ROOT ?>/lockers" class="d-flex align-items-center text-white text-decoration-none hover-bg-light rounded px-5 py-3 mb-2 w-100">
            <i class="bi bi-lock me-2"></i>Lockers
        </a>
        <a href="<?= ROOT ?>/transactions" class="d-flex align-items-center text-white text-decoration-none hover-bg-light rounded px-5 py-3 mb-2 w-100">
